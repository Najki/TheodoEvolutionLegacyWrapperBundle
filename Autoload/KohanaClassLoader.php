...
use Theodo\Evolution\Bundle\LegacyWrapperBundle\Kernel\KohanaKernel;
 ...
 */
class KohanaClassLoader implements LegacyClassLoaderInterface
{
    /**
     * @var boolean
     */
...
//        require_once BASEPATH . 'core/Controller.php';
    ...
    {
        if (!$kernel instanceof KohanaKernel) {
            throw new \InvalidArgumentException(sprintf('The "%s" expects a KohanaKernel, "%s" given', __CLASS__, get_class($kernel)));
        }
